...
func UserList(c *cli.Context, client gomematic.ClientAPI) error {
...
func UserShow(c *cli.Context, client gomematic.ClientAPI) error {
...
func UserDelete(c *cli.Context, client gomematic.ClientAPI) error {
...
func UserUpdate(c *cli.Context, client gomematic.ClientAPI) error {
	record, err := client.UserGet(
		GetIdentifierParam(c),
	)
...
func UserCreate(c *cli.Context, client gomematic.ClientAPI) error {
	record := &gomematic.User{}
...
func UserTeamList(c *cli.Context, client gomematic.ClientAPI) error {
...
func UserTeamAppend(c *cli.Context, client gomematic.ClientAPI) error {
...
func UserTeamPerm(c *cli.Context, client gomematic.ClientAPI) error {
...
func UserTeamRemove(c *cli.Context, client gomematic.ClientAPI) error {
