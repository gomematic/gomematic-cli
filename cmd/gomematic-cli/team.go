...
func TeamList(c *cli.Context, client gomematic.ClientAPI) error {
...
func TeamShow(c *cli.Context, client gomematic.ClientAPI) error {
...
func TeamDelete(c *cli.Context, client gomematic.ClientAPI) error {
...
func TeamUpdate(c *cli.Context, client gomematic.ClientAPI) error {
	record, err := client.TeamGet(
		GetIdentifierParam(c),
	)
...
func TeamCreate(c *cli.Context, client gomematic.ClientAPI) error {
	record := &gomematic.Team{}
...
func TeamUserList(c *cli.Context, client gomematic.ClientAPI) error {
...
func TeamUserAppend(c *cli.Context, client gomematic.ClientAPI) error {
...
func TeamUserPerm(c *cli.Context, client gomematic.ClientAPI) error {
...
func TeamUserRemove(c *cli.Context, client gomematic.ClientAPI) error {
